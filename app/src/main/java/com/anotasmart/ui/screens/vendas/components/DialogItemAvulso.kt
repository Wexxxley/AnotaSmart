...
@Composable
fun DialogAdicionarCarrinhoItemAvulso(
    onDismissRequest: () -> Unit,
    onConfirmar: (precoCusto: Double?, precoVenda: Double, quantidade: Double) -> Unit
) {
    ...
    val pVenda = precoVenda.toDoubleOrNull() ?: 0.0
    val valorTotal = pVenda * quantidadeSelecionada
    ...
    AlertDialog(
        ...
        confirmButton = {
            Box(
                ...
                Button(
                    onClick = {
                        val pCusto = precoCusto.toDoubleOrNull()
                        onConfirmar(pCusto, pVenda, quantidadeSelecionada)
                    },
                    modifier = Modifier.fillMaxWidth(),
